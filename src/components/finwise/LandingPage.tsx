  ...
  return (
    ...
    >
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        />
        <div
          className="absolute -right-40 top-1/3 h-[28rem] w-[28rem] rounded-full opacity-30 blur-3xl"
          style={{ background: "radial-gradient(circle, oklch(0.72 0.15 210) 0%, transparent 70%)" }}
        />
        <div
          className="absolute left-1/3 -bottom-40 h-96 w-96 rounded-full opacity-25 blur-3xl"
          style={{ background: "radial-gradient(circle, oklch(0.65 0.20 305) 0%, transparent 70%)" }}
        />
      </div>
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-4 pb-16 pt-8 sm:px-6 sm:pt-16 lg:px-8 lg:pb-24 lg:pt-20">
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div className="text-center lg:text-left">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs font-medium text-emerald-300 backdrop-blur-sm">
            ...
            <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row lg:justify-start">
              ...
              <Button asChild size="lg" variant="outline" className="w-full gap-2 border-white/20 bg-white/5 sm:w-auto">
      ...
      {/* Final CTA */}
      <section className="relative z-10 mx-auto max-w-4xl px-4 pb-20 pt-8 text-center sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          ...
          <Button asChild size="lg" variant="outline" className="w-full border-white/20 bg-white/5 sm:w-auto">
            <Link to="/demo">{t("landing.hero.ctaSecondary", "Ver demonstração")}</Link>
          </Button>
        </div>
      </section>
...
function Feature({ icon, color, title, desc }: { icon: React.ReactNode; color: string; title: string; desc: string }) {
  return (
    <Card className="border-white/10 bg-white/5 backdrop-blur-sm transition-all hover:-translate-y-0.5 hover:bg-white/10">
